...
<footer>
    ...
    <div className="container px-4 mx-auto">
      <div className="-mx-4 flex flex-wrap justify-between">
        <div className="px-4 my-4 w-full xl:w-1/5">
          ...
          A hospital management system streamlines operations like patient registration, appointments, billing, and medical records, ensuring better coordination between staff and improved patient care. It also manages inventory, reports, and administrative tasks efficiently.
            </p>
        </div>
        <div className="px-4 my-4 w-full sm:w-auto">
          ...
          <ul className="leading-8">
            <li><a href="/Createpatientformm" className="hover:text-blue-400">Register patient</a></li>
            <li><a href="/gettreatment" className="hover:text-blue-400">Treatments</a></li>
            <li><a href="/sendmessageform" className="hover:text-blue-400">Talk to me</a></li>
        ...
        <div className="px-4 my-4 w-full sm:w-auto">
          ...
          {/* <ul className="leading-8"> */}
            ...
            <p className=''>Hospital management systems streamline <br /> operations by integrating patient <br /> care, staff management, and billing processes <br /> into a unified platform. With features like <br /> electronic medical records (EMR), appointment scheduling, and  <br /> automated billing, they enhance operational efficiency and reduce errors. <br /> These systems ensure secure data management, real-time <br /> updates, and seamless coordination among departments. </p>
          {/* </ul> */}
  ...
  <div className="bg-blue-600 py-4 text-gray-100"> 
    <div className="container mx-auto px-4">
      <div className="-mx-4 flex flex-wrap justify-between">
        <div className="px-4 w-full text-center sm:w-auto sm:text-left">
          Copyright © zohaib.ch.2208@gmail.com
        </div> 
        {/* <div className="px-4 w-full text-center sm:w-auto sm:text-left">
